...
import GoalEditPage from "./components/GoalEditPage";
import BodyInputEditPage from "./components/BodyInputEditPage";
function App() {
  return (
    <AuthProvider>
      <BrowserRouter>
        
        {
          <Routes>
            ...
            <Route path="/body-edit" element={<BodyInputEditPage />} />
