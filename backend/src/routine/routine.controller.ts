...
export class RoutineController {
  ...
  async getRoutine(@Body('userId') userId: string) {
    ...
    if (!goal || !body) {
      throw new NotFoundException('goal ཨོང body སྐང་གན།།ཨི་པ།།ཨན་སན་ོང་ས་།།ཨ་ང་།།ཨ་ཨ་།།ཨ་ང་།།་ང་།།་ཨ་ང་།།་།་།།་།་།།་།་།།་།་།།་།་།།');
    }
  ...
  async getExerciseInfo(
    ...
    if (!fs.existsSync(dbPath)) {
      throw new NotFoundException('routines.json སན་ཨ་།།ཨ་སན་ཨ་།།');
    }
          ...
          for (const ex of parts[partKey][levelKey]) {
            ...
            if (nameMatches && partMatches) {
              ...
              return {
                ...
                part: partKey,
                description:
                  ex.description || `${partKey} ནུས སྐང སུན།།`,
    ...
    throw new NotFoundException(`${name} གི་།།་ །་།།ཨ་།།་ སན་ཨ་།།`);
  }
